  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        >
          КУЗБАСС · СИБИРЬ · НАТУРАЛЬНЫЕ МАСЛА
        </div>
        ...
        >
          Натуральные эфирные масла сибирской пихты.<br />
          Для автомобиля и дома.
        </p>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            >
              Организация «Тайга» расположена в сердце Кузбасса — там, где вековые пихтовые леса
              хранят вековые тайны сибирской природы. Мы создаём ароматизаторы исключительно
              из натуральных эфирных масел, собранных в экологически чистых районах Сибири.
            </p>
            <p
              className="reveal text-sm leading-7 mt-4"
              style={{ color: "var(--text-muted)" }}
            >
              Никакой химии. Никаких синтетических отдушек. Только живой, настоящий аромат
              сибирской тайги — для вашего автомобиля и дома.
            </p>
          </div>
          ...
          {[
            {
              icon: "Leaf",
              title: "Экологично",
              text: "Только природные компоненты, без синтетики и химических добавок",
            },
            {
              icon: "MapPin",
              title: "Местное производство",
              text: "Производим в Кузбассе, используем ресурсы сибирской тайги",
            },
            {
              icon: "Star",
              title: "Ручная работа",
              text: "Каждый флакон создаётся с вниманием к качеству и деталям",
            },
          ].map((item, i) => (
            <div
              key={i}
          ...
          {[
            {
              ...
              text: "Компактный флакон на дефлектор или зеркало. Аромат держится 30–45 дней, не перебивает концентрацию во время езды.",
            },
            {
              icon: "Home",
              title: "Для дома",
              text: "Создаёт атмосферу сибирской тайги в вашем пространстве. Подходит для спальни, гостиной, рабочего кабинета.",
            },
          ].map((item, i) => (
            <div
              key={i}
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="reveal info-card p-10">
            ...
            <p className="text-xs leading-7 mb-8" style={{ color: "var(--text-muted)" }}>
              Приобрести нашу продукцию можно напрямую у производителя. Свяжитесь с нами
              любым удобным способом — мы расскажем об актуальных ценах и условиях доставки
              по Кузбассу и всей России.
            </p>
          ...
          <div className="reveal info-card p-10" style={{ animationDelay: "0.15s" }}>
            ...
            <p className="text-xs leading-7 mb-8" style={{ color: "var(--text-muted)" }}>
              Мы открыты к сотрудничеству с магазинами, автосервисами, сетями АЗС и
              другими торговыми партнёрами. Предлагаем выгодные условия оптовых поставок
              и эксклюзивное партнёрство в вашем регионе.
            </p>
            <div className="space-y-3">
              {[
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p
            ...
            style={{ color: "var(--text-muted)" }}
          >
            Мы всегда рады ответить на ваши вопросы — о продукции, ценах,
            доставке или партнёрском сотрудничестве.
          </p>
        </div>
    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div
          ...
          style={{ color: "var(--text-muted)", fontSize: "0.65rem" }}
        >
          © 2024 Тайга. Ароматизаторы из натуральных сибирских масел. Кузбасс.
        </div>
